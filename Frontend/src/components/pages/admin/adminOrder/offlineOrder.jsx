...
const OfflineOrder = () => {
  ...
  const [paymentStatus, setPaymentStatus] = useState(status[0]);
  ...
  const Order = () => {
    let offlineOrder = orders;
    if (searchQuery) {
      offlineOrder = offlineOrder?.filter((data) => {
  ...
  return (
    <div>
      <div style={{ height: "100vh", overflowY: "scroll", userSelect: "text" }}>
        {" "}
        <br />
        <h1 style={{ textAlign: "center" }}>
          Admin : Total Offline Order
        </h1>{" "}
        <br /> <br />
        <Link
          style={{
              ...
              <div key={m._id}>
                {m.PaymentMethod === "COD" && (
                  <div>
                    ...
                    <p style={{ padding: "0 0 0 20px" }}>
                      {" "}
                      Total Price: <b>Rs.{m.totalPrice / 100}/-</b>{" "}
                    </p>
                    <p style={{ padding: "0 0 0 20px" }}>
                      {" "}
                      Delivery charge: <b>Rs.{m.deliveryCahrge}/-</b>{" "}
                    </p>
                    <p style={{ padding: "0 0 0 20px" }}>
                      {" "}
                      Total Amount : <b>Rs.{m.total / 100}/-</b>{" "}
                    </p>
                    <p style={{ padding: "0 0 0 20px" }}>
                      {" "}
